...
namespace Permission.Infrastructure.Seeder;
        ...
        IUserAccountService userAccountService, IUserRoleService userRoleService) : IDatabaseSeeder
{
    ...
    private async Task SeedDefaultUsersAsync()
    {
        if (!await dbContext.Users.AnyAsync())
        {
            ...
            // const string supperRoleName = "SUDO_Supper_User_Do";
            ...
            await EnsureRoleAsync(SystemConst.SudoRole, "Default user", []); // 👉 Don't need ACTION 😱😱😱
            ...
            await CreateUserAsync("supper",
                                  "Supper@123$",
                                  "Inbuilt Standard User",
                                  "supper@ebenmonney.com",
                                  "+1 (123) 000-0001",
                                  [SystemConst.SudoRole]);

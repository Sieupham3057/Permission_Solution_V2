...
public class UserAccountService : IUserAccountService
{
	...
	public async Task<(ApplicationUser User, string[] Roles)?> GetUserAndRolesAsync(Guid userId)
	{
	...
	public async Task<(bool Success, string[] Errors)> TestCanDeleteUserAsync(Guid userId)
	{
